...
Route::prefix('v1/front')->group(function () {
    ...
    Route::get('portfolios/{slug}', [PortfolioController::class,'frontDetail'])->name('portfolio-frontDetail');
    Route::get('portfolios/{slug}/similar', [PortfolioController::class,'similar'])->name('portfolio-similar');
